 ...
 * @LastEditTime: 2023-03-10 11:02:55
 * @Description : 动态稳定测试-具体测量
-->
<template>
  <div class="test-dynamic-stability-measure">
    <div class="wrapper">
      <div class="main">
        <div class="left">
...
export default {
  ...
  data() {
    return {
      ...
      timeBgSrc: require('@/assets/img/Test/Dynamic_Stability/Measure/倒计时背景.png'), // 倒计时背景
...
.test-dynamic-stability-measure {
  width: 100%;
  height: 100%;
