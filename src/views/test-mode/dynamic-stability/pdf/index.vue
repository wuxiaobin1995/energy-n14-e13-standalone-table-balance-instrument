 ...
 * @LastEditTime: 2023-02-02 18:01:51
 * @Description : 动态稳定测试-PDF
-->
<template>
  <div
    class="test-dynamic-stability-pdf"
...
export default {
  ...
  methods: {
    ...
    handlePdf() {
      this.$htmlToPdf(
        'pdf',
        `动态稳定测试报告 ${this.$moment().format('YYYY-MM-DD HH_mm_ss')}`,
        420
      )
    },
