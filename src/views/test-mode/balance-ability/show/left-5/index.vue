  ...
  <div class="test-show">
    ...
    <div class="wrapper">
      <div class="left">
        ...
        <div class="type">
          <span class="type__item-1">一档闭眼直立</span>
...
export default {
  ...
  data() {
    return {
      actionImg: require('@/assets/img/Test/Balance_Ability/Show/l5.png'),

      /* 语音相关 */
      audioOpen: this.$store.state.voiceSwitch,
      audioSrc: path.join(__static, `narrate/mandarin/l5.mp3`),
  ...
  methods: {
    ...
    handleStart() {
      this.$router.push({
        ...
        query: {
          showName: JSON.stringify('test-show-left-5'),
          nextRouterName: JSON.stringify('/test-show-right-5')
        }
      })
    }
  }
