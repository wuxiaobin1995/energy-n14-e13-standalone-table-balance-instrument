 ...
 * @LastEditTime: 2023-02-09 15:00:12
 * @Description : 二档闭眼屈膝-左腿
-->
<template>
  <div class="test-show">
    <!-- 语音播放 -->
...
export default {
  ...
  data() {
    return {
      actionImg: require('@/assets/img/Test/Balance_Ability/Show/l8.png'),

      /* 语音相关 */
      audioOpen: this.$store.state.voiceSwitch,
      audioSrc: path.join(__static, `narrate/mandarin/l8.mp3`),
  ...
  methods: {
    ...
    handleStart() {
      this.$router.push({
        ...
        query: {
          showName: JSON.stringify('test-show-left-8'),
          nextRouterName: JSON.stringify('/test-show-right-8')
        }
      })
    }
  }
