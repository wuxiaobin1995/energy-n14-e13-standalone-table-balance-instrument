 ...
 * @LastEditTime: 2023-03-15 11:10:23
 * @Description : 一档睁眼屈膝-左腿
-->
<template>
  <div class="test-show">
    <!-- 语音播放 -->
...
export default {
  ...
  data() {
    return {
      actionImg: require('@/assets/img/Test/Balance_Ability/Show/l2.png'),

      /* 语音相关 */
      audioOpen: this.$store.state.voiceSwitch,
      audioSrc: path.join(__static, `narrate/mandarin/l2.mp3`),
  ...
  methods: {
    ...
    handleStart() {
      this.$router.push({
        ...
        query: {
          showName: JSON.stringify('test-show-left-2'),
          nextRouterName: JSON.stringify('/test-show-right-2')
        }
      })
    }
  }
