 ...
 * @LastEditTime: 2023-02-09 14:28:45
 * @Description : 一档睁眼屈膝-右腿
-->
<template>
  <div class="test-show">
    <!-- 语音播放 -->
    ...
    <div class="wrapper">
      <div class="left">
        ...
        <div class="type">
          <span class="type__item-1">一档睁眼屈膝</span>
...
export default {
  ...
  data() {
    return {
      actionImg: require('@/assets/img/Test/Balance_Ability/Show/r2.png'),

      /* 语音相关 */
      audioOpen: this.$store.state.voiceSwitch,
      audioSrc: path.join(__static, `narrate/mandarin/r2.mp3`),
  ...
  methods: {
    ...
    handleStart() {
      this.$router.push({
        ...
        query: {
          showName: JSON.stringify('test-show-right-2'),
          nextRouterName: JSON.stringify('/test-show-left-3')
        }
      })
    }
  }
