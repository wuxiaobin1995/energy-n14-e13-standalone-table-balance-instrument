 ...
 * @LastEditTime: 2023-02-09 14:57:47
 * @Description : 二档睁眼屈膝-左腿
-->
<template>
  <div class="test-show">
    <!-- 语音播放 -->
    ...
    <div class="wrapper">
      <div class="left">
        ...
        <div class="type">
          <span class="type__item-1">二档睁眼屈膝</span>
...
export default {
  ...
  data() {
    return {
      actionImg: require('@/assets/img/Test/Balance_Ability/Show/l4.png'),

      /* 语音相关 */
      audioOpen: this.$store.state.voiceSwitch,
      audioSrc: path.join(__static, `narrate/mandarin/l4.mp3`),
  ...
  methods: {
    ...
    handleStart() {
      this.$router.push({
        ...
        query: {
          showName: JSON.stringify('test-show-left-4'),
          nextRouterName: JSON.stringify('/test-show-right-4')
        }
      })
    }
  }
