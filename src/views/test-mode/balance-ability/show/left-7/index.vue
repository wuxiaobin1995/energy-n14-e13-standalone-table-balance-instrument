...
export default {
  ...
  data() {
    return {
      actionImg: require('@/assets/img/Test/Balance_Ability/Show/l7.png'),

      /* 语音相关 */
      audioOpen: this.$store.state.voiceSwitch,
      audioSrc: path.join(__static, `narrate/mandarin/l7.mp3`),
  ...
  methods: {
    ...
    handleStart() {
      this.$router.push({
        ...
        query: {
          showName: JSON.stringify('test-show-left-7'),
          nextRouterName: JSON.stringify('/test-show-right-7')
        }
      })
    }
  }
