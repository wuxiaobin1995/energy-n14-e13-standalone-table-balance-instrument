  ...
  <div class="test-show">
    ...
    <div class="wrapper">
      <div class="left">
        ...
        <div class="type">
          <span class="type__item-1">一档闭眼屈膝</span>
...
export default {
  ...
  data() {
    return {
      actionImg: require('@/assets/img/Test/Balance_Ability/Show/l6.png'),
  ...
  methods: {
    ...
    handleStart() {
      this.$router.push({
        ...
        query: {
          showName: JSON.stringify('test-show-left-6'),
          nextRouterName: JSON.stringify('/test-show-right-6')
        }
      })
    }
  }
