 ...
 * @LastEditTime: 2023-02-09 14:28:34
 * @Description : 一档睁眼直立-右腿
-->
<template>
  <div class="test-show">
    <!-- 语音播放 -->
...
export default {
  ...
  data() {
    return {
      actionImg: require('@/assets/img/Test/Balance_Ability/Show/r1.png'),

      /* 语音相关 */
      audioOpen: this.$store.state.voiceSwitch,
      audioSrc: path.join(__static, `narrate/mandarin/r1.mp3`),
  ...
  methods: {
    ...
    handleStart() {
      this.$router.push({
        ...
        query: {
          showName: JSON.stringify('test-show-right-1'),
          nextRouterName: JSON.stringify('/test-show-left-2')
        }
      })
    }
  }
