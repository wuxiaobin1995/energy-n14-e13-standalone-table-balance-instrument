 ...
 * @LastEditTime: 2023-03-15 11:13:57
 * @Description : 二档睁眼直立-右腿
-->
<template>
  <div class="test-show">
    <!-- 语音播放 -->
...
export default {
  ...
  data() {
    return {
      actionImg: require('@/assets/img/Test/Balance_Ability/Show/r3.png'),

      /* 语音相关 */
      audioOpen: this.$store.state.voiceSwitch,
      audioSrc: path.join(__static, `narrate/mandarin/r3.mp3`),
  ...
  methods: {
    ...
    handleStart() {
      this.$router.push({
        ...
        query: {
          showName: JSON.stringify('test-show-right-3'),
          nextRouterName: JSON.stringify('/test-show-left-4')
        }
      })
    }
  }
